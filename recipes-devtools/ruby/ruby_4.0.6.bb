...
# Version bump 4.0.2 -> 4.0.6, carried in meta-trmnl until oe-core catches
# up: Terminus (usetrmnl/terminus) pins .ruby-version to 4.0.6 exactly and
# Bundler.setup enforces that at runtime. Patch set copied verbatim from
# oe-core's ruby_4.0.2.bb.
#
# 0003-rdoc-build-reproducible-documentation.patch dropped: it targets a
# bundled rdoc path/version that moved between 4.0.2 and 4.0.6, and
# PACKAGECONFIG[rdoc] (--enable-install-rdoc) is off by default anyway.
