SUMMARY = "Run Terminus's containers via podman-compose instead of Quadlet"
...
terminus-container-image.bb writes into the rootfs (not packaged here -- \
see trmnl-compose-deploy.inc for why). The shared logic \
(trmnl-compose-deploy.inc) is generic across every trmnl app; this recipe \
is the thin per-image half -- see inker-compose-deploy_1.0.bb for the \
other consumer."
